...
namespace Raspisanie.ViewModels
{
    public class TeachersAndSubjectsVM : ViewModelBase
    {
        ...
        private readonly INotifyingValue<int> allDaysIndex;
        ...
        public TeachersAndSubjectsVM(Teacher teacher,List<Subject> subectsList, List<DayOfWeek> daysList)
        {
            ...
            allDaysIndex = this.Factory.Backing(nameof(AllDaysList), -1);
            Teacher = teacher;
            saveTeachersAndSubjects = this.Factory.CommandSyncParam<Window>(SaveAndClose);
        }

        public TeachersAndSubjectsVM(TeachersAndSubjectsView teacherAndsubject,List<Subject> subectsList, List<DayOfWeek> daysList) //: this(subectsList, daysList)
        {
        ...
        public int AllDaysList { get { return allDaysIndex.Value; } set { allDaysIndex.Value = value; } }
