    ...
    class XML
    {
        ...
        public static XElement CreateXMLTeacher(Teacher teacher)
        {
            return new XElement("Teacher",
                ...
                new XElement("HourOfLoad", teacher.HourOfLoad),
                new XElement("CodeOfDepartment", teacher.CodeOfDepartment));
        }
        ...
        public static XElement CreateXMLSubject(Subject subject)
        {
            return new XElement("Subject",
                ...
                new XElement("LectureHours", subject.LectureHours),
                new XElement("ExerciseHours", subject.ExerciseHours),
                new XElement("LaboratoryHours", subject.LaboratoryHours),
                new XElement("CommonHours", subject.CommonHours),
