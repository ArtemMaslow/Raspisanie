...
namespace Raspisanie.ViewModels
{
    class SubjectVM : ViewModelBase
    {
        ...
        public SubjectVM(Subject subject, Department[] departments) : this(departments)
        {
            ...
            commonHours.Value = subject.CommonHours;
            lectureHours.Value = subject.LectureHours;
            laboratoryHours.Value = subject.LaboratoryHours;
            exerciseHours.Value = subject.ExerciseHours;
